;(function( $, window, document, undefined){
  ...
  defaultCallback = function(){
    ...
    alert("The llama god is coming");
    console.log(document.getElementsByClassName("column"));
    for( var i = 0 ; i <= 3 ; i++ ){
      document.getElementsByClassName("column")[i].innerHTML = '<h2>Who is your god now?</h2><img width=200px height=auto src="resources/img/llama.png">';
    }
  }
